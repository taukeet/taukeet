...
class Settings extends Equatable {
    ...
    const Settings({
        ...
        required this.hasFetchedInitialLocation,
    ...
    Settings copyWith({
        ...
        Settings(
            ...
            hasFetchedInitialLocation: hasFetchedInitialLocation ?? this.hasFetchedInitialLocation,
    ...
    factory Settings.fromMap(Map<String, dynamic> json) => Settings(
        ...
        hasFetchedInitialLocation: json["has_fetched_initial_location"] ?? false,
